...
public abstract class ProductTestValues {
    ...
    public static final Product urbanArttxStrickerSave = new Product(18273645, "UrbanArtt x Striker Custom Stunt Scooter", "Featuring a range of high quality components from UrbanArtt, Striker, District, Blazer Pro and Eagle Sport brands",
                                                                             "Chrome/Black/Blue", "950x118", "Aluminium", 420);
